...
('<section id="about" className="h-full flex flex-col items-center justify-center text-center"> <h1 className="font-bold my-16">About Us</h1> <h2 className="my-24">Our Story</h2> <p className="my-4"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam consectetur, nisl id hendrerit consequat, urna odio interdum lectus. </p> </section>', NOW());
